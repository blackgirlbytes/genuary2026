...
def main():
    ...
    post_text = f"""I automated my entire Genuary. The art, the posts, even this caption... all generated by my AI agent, goose.

This is my Genuary day {day} submission: "{prompt_title}"

🔹 Built one piece with goose recipes + a shell script
🔹 Built the other with Agent Skills

Code + agent transcripts: https://github.com/blackgirlbytes/genuary2026

#genuary #generativeart #aiagents"""
